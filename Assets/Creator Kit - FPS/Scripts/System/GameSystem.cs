...
public class GameSystem : MonoBehaviour
{
   ...
   public void Win()
	{
      ...
      Controller.Instance.DisplayCursor(true);
      Controller.Instance.CanPause = false;
      FinalScoreUI.Instance.DisplayWin();
   ...
   public void Lose()
	{      
      ...
      Controller.Instance.DisplayCursor(true);
      Controller.Instance.CanPause = false;
      FinalScoreUI.Instance.DisplayLoss();
   ...
   IEnumerator EndGame()
    ...
    void RetrieveTargetsCount()
    {
        ...
        GameSystemInfo.Instance.UpdateScore(100);
    ...
    public void ChangeHealth()
	 {
      if (m_Score > 0)
		{
         GameSystemInfo.Instance.UpdateScore(m_Score -= 10);
		}
		if (m_Score == 0)
		{
         Lose();
